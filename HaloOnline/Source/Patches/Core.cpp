...
namespace
{
	...
	void preferences_set_defaults_hook()
	{
		...
		Bungie::Preferences *preferences = HaloOnline::GetMainTls(0x18)[0];
	...
	void __fastcall campaign_scoring_sub_6E59A0(char *scoreboard, void *, Bungie::DatumHandle handle, Bungie::Events::EventType event_type, short a4, Bungie::ePlayerStatType player_stat_type, char a6)
	{
		...
		*((short *)scoreboard_unknown + 2) = v8;
		...
		if (a6)
		{
			...
			{
				auto player_datum = (Bungie::Players::PlayerDatum*)data_array_sub_55B710(HaloOnline::Instance().GetMainTls(0x40).Read<Bungie::DataArray<Bungie::Players::PlayerDatum>*>(), handle);
	...
	void __cdecl sub_6948C0_hook(int a1)
	{
		...
		auto *tls = (Bungie::Memory::tls_data *)HaloOnline::Instance().GetMainTls();
