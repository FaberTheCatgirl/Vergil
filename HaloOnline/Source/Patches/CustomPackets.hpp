 ...
 *    or "HaloOnline" for packets built into HaloOnline. This helps ensure
 *    uniqueness.
 *
 *    auto handler = std::make_shared<ExamplePacketHandler>();
 *    auto myPacketSender = Patches::CustomPacket::RegisterPacket<ExamplePacketData>("HaloOnline-example-packet", handler);
 *
