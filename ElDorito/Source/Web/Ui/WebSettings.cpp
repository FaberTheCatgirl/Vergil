...
namespace
{
	...
	void OnGameInputUpdated()
	{
		...
		{
			if (Bungie::Input::GetActionState(Bungie::Input::eGameActionUiStart)->Ticks == 1 && strcmp((char*)Pointer(0x22AB018)(0x1A4), "mainmenu") == 0)
				Web::Ui::WebSettings::Show();
		}

		if (GetKeyTicks(Bungie::Input::eKeyCodeHome, Bungie::Input::eInputTypeUi) && strcmp((char*)Pointer(0x22AB018)(0x1A4), "mainmenu") == 0)
		{
